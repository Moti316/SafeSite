...
112 הסעיפים ו-13 המסמכים יושבים בקבצי נתונים גרסאיים תחת `data/`.
הקוד קורא אותם, לא מכיל אותם. עדכון רגולציה הוא שינוי נתונים עם
היסטוריה, לא deploy.

**אפס תלות חיצונית בזמן ריצה.**
כל ספרייה נארזת ב-bundle ונטענת מאותו דומיין. המערכת הישנה טענה את
Supabase ואת מנוע ה-PDF מ-CDN חיצוני — ויש בה קובץ בשם `cdn-guard.js`,
עדות לכך שזה כבר נכשל.
...
שגויה. ראה [`14-ROADMAP.md`](14-ROADMAP.md) שלב 7.

...
**מה שקרה במערכת הישנה:** המצב השתנה בשלב 1. ביטול לא החזיר אותו.
התוצאה — סעיף מסומן ליקוי בלי רשומת ליקוי, ושלושה מסכים סותרים.
ראה [`15-AUDIT-FINDINGS.md`](15-AUDIT-FINDINGS.md#f1).
